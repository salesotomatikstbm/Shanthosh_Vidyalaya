...
const Contact = () => {
  return (
    <Layout bodyClass={"contact"}>
      ...
      <section className="tf-section tf-contact" style={{ marginTop: "50px" }}>
        <div className="container">
          <div className="row">
...
<p className="f-mulish">
  We are here to assist you with any queries or information you need. Reach out to us and let’s work together to make things happen!
</p>
              ...
              <div className="wrap-contact">
                <div className="fx adress">
                  ...
                  <div className="content">
                    <p>Address</p>
                    <h4>No 9, Gangai Street, Tambaram East, Chennai - 600059 (Near Balaji Nagar Irumbuliyur)</h4>
                  </div>
                </div>
        ...
        <div className="tf-section map">
          <div className="flat-map">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3888.950273556222!2d80.1061994!3d12.9109176!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTLCsDU0JzM5LjMiTiA4MMKwMDYnMjIuMyJF!5e0!3m2!1sen!2sin!4v1737968489386!5m2!1sen!2sin"
              width={1720}
              height={655}
              style={{
                border: 0,
