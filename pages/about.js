                ...
                <div className="col-discovery">
                  ...
                  >
                    ...
                    <div className="box-content">
                      <h4 className="title">
                        <Link href="/classes">
                          <a>Our Events &amp; Programs</a>
                        </Link>
                      </h4>
                      <p className="wrap f-mulish">
                      Engaging academic and extracurricular programs designed to enhance student growth.
                      </p>
                      {/* <Link href="/classes">
                ...
                <div className="col-discovery">
                  ...
                  >
                    ...
                    <div className="box-content">
                      <h4 className="title">
                        <Link href="/program">
                          <a>Annual &amp; Competitions</a>
                        </Link>
                      </h4>
                      <p className="wrap f-mulish">
                      Competitions fostering creativity, critical thinking, and talent development.
                      </p>
                      {/* <Link href="/program">
                        <a className="fl-btn st-13">
                          <span className="inner">read more</span>
                ...
                <div className="col-discovery">
                  ...
                  >
                    ...
                    <div className="box-content">
                      <h4 className="title">
                        <Link href="/teacher">
                          <a>Outdoor Activities & Sports</a>
                        </Link>
                      </h4>
                      <p className="wrap f-mulish">
                      Promoting fitness, teamwork, and healthy living through outdoor games and sports.
                      </p>
                      {/* <Link href="/teacher">
                        <a className="fl-btn st-13">
                          <span className="inner">read more</span>
                ...
                <div className="col-discovery">
                  ...
                  >
                    ...
                    <div className="box-content">
                      <h4 className="title">
                        <Link href="/events">
                          <a>Cultural & Co-curricular Events</a>
                        </Link>
                      </h4>
                      <p className="wrap f-mulish">
                      Encouraging participation in dance, music, and drama to nurture creativity and cultural appreciation.
                      </p>
                      {/* <Link href="/events">
                        <a className="fl-btn st-13">
                          <span className="inner">read more</span>
                  ...
                  <div className="box-content st-1">
                    <h4 className="name">
                      <Link href="/teacher-details">
                        <a className="clr-pri-1">Teacher 1</a>
                      </Link>
                    </h4>
              ...
              <SwiperSlide>
                ...
                >
                  ...
                  <div className="box-content st-3">
                    <h4 className="name">
                      <Link href="/teacher-details">
                        <a className="clr-pri-1">Teacher 2</a>
                      </Link>
                    </h4>
                    <p className="sub f-mulish clr-pri-1">
              ...
              <SwiperSlide>
                ...
                >
                  ...
                  <div className="box-content st-4">
                    <h4 className="name">
                      <Link href="/teacher-details">
                        <a className="clr-pri-1">Teacher 3</a>
                      </Link>
                    </h4>
                    <p className="sub f-mulish clr-pri-1">
              ...
              >
                <div className="wrap">
                  <h2 className="title clr-pri-1">
                   Ready To Admit Your Child to Santhosh Vidyalaya?
                  </h2>
                  <p className="sub clr-pri-1 f-mulish">
                  Join us at Santhosh Vidyalaya, where education meets excellence and holistic development.
                  </p>
                </div>
